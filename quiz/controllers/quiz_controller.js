...
exports.create = function(req, res) {
	...
	.then(
		function(err){
			if(err) {
			res.render('quizes/new', {quiz: quiz, errors: err.errors, cuestionario: cuestionario});
			} else {
...
exports.edit = function(req, res) {
	...
	var cuestionario= req.cuestionario;
    res.render('quizes/edit', {quiz: quiz, cuestionario: cuestionario});
};
...
exports.update = function(req, res) {
    ...
    req.quiz
            ...
            function(err){
                if(err){
                    res.render('/cuestionarios',{quiz: req.quiz, cuestionario: req.cuestionario});
                }else{
                    req.quiz
