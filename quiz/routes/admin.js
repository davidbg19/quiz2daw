...
//Comments
router.get('/cuestionarios/:cuestionarioId(\\d+)/quizes/:quizId(\\d+)/comments/new', 					 sessionController.adminRequired, commentController.new);
router.post('/cuestionarios/:cuestionarioId(\\d+)/quizes/:quizId(\\d+)/comments', 						 sessionController.adminRequired, commentController.create);
router.get('/cuestionarios/:cuestionarioId(\\d+)/quizes/:quizId(\\d+)/comments/:comentId(\\d+)/publish', sessionController.adminRequired, commentController.publish);

//Cuestionarios
router.get('/cuestionarios',							sessionController.loginRequired, cuestionarioController.index);//ruta de listado de cuestionarios
router.get('/cuestionarios/:cuestionarioId(\\d+)/edit', sessionController.adminRequired, cuestionarioController.edit);
router.put('/cuestionarios/:cuestionarioId(\\d+)', 		sessionController.adminRequired, cuestionarioController.update);
...
router.get('/grupos/:grupoId(\\d+)', 			sessionController.adminRequired,	grupoController.show);
...
//Materias
router.get('/materias', 						sessionController.adminRequired, materiaController.index);
router.get('/materias/:materiaId(\\d+)', 		sessionController.adminRequired, materiaController.show);
...
//Observaciones
router.get('/observaciones/:observacionId(\\d+)', 		sessionController.adminRequired, observacionController.show);
...
router.get('/cuestionarios/:cuestionarioId(\\d+)/quizes/:quizId(\\d+)/answer', sessionController.loginRequired, quizController.answer);
router.get('/cuestionarios/:cuestionarioId(\\d+)/quizes/new', 					sessionController.adminRequired, quizController.new);
router.post('/cuestionarios/:cuestionarioId(\\d+)/quizes/create', sessionController.adminRequired, quizController.create);
router.get ('/cuestionarios/:cuestionarioId(\\d+)/quizes/:quizId(\\d+)/edit', 	sessionController.adminRequired, quizController.edit);
router.put('/cuestionarios/:cuestionarioId(\\d+)/quizes/:quizId(\\d+)', 		sessionController.adminRequired, quizController.update);
router.delete('/cuestionarios/:cuestionarioId(\\d+)/quizes/:quizId(\\d+)', 		sessionController.adminRequired, quizController.destroy);
